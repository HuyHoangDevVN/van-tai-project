...
public class ChuyenXeController : ControllerBase
{
    ...
    /// 2. Tính toán km v?n hành: KM tăng = QuangDuong × HeSoKhoKhan
...
public class TuyenDuongController : ControllerBase
{
    ...
    /// <summary>
    /// T?m ki?m tuy?n đư?ng v?i phân trang và l?c.
    /// </summary>
    [HttpGet("tim-kiem")]
...
public class VeController : ControllerBase
{
    ...
    /// <summary>
    /// Đ?t vé cho khách hàng.
    /// </summary>
    /// <remarks>
    /// **Constraint Check**: Stored procedure ki?m tra:
    /// - Chuy?n xe t?n t?i và đang ? tr?ng thái có th? đ?t (Scheduled)
    /// - S? vé đ? bán &lt; S? gh? c?a xe (capacity check)
    /// - Gh?/giư?ng c? th? chưa đư?c đ?t (n?u có ch? đ?nh)
    /// </remarks>
    [HttpPost("dat-ve")]
    ...
    /// <remarks>
    /// Ch? có th? h?y vé khi:
    /// - Vé chưa đư?c h?y trư?c đó
    /// - Chuy?n xe chưa hoàn thành
    /// </remarks>
    [HttpPut("{stt:int}/huy")]
    [ProducesResponseType(typeof(BaseResponse<object>), 200)]
    [ProducesResponseType(typeof(BaseResponse<object>), 400)]
